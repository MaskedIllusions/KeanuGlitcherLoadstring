-- No I Did Not Steal The Script Im Making A Loadstring For It Respectful Owner Goes To Keanu Reeves#3227 For His Epic Glitcher
-- Btw Renamed To Rain FE Instead Of Masked Hub Lol
-- Final Message But Enjoy This Epic Script
--Achromatix <3-- 
...
local modeInfo={
    ...
    {Name="Hacker",Walkspeed=70,moveVal=7,Font=Enum.Font.Ubuntu,StrokeColor=C3.N(.39, .70, .45);Music=385014277,LeftWing={0,BrickColor.new'Lime green'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Lime green'.Color,Enum.Material.Grass};WingAnim={'Sex', 10}};
    {Name="Hacking In Progress",Walkspeed=0,moveVal=7,Font=Enum.Font.Ubuntu,StrokeColor=C3.N(.39, .70, .45);Music=385014277,LeftWing={0,BrickColor.new'Lime green'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Lime green'.Color,Enum.Material.Grass};WingAnim={'Sex', 10}};
...
UIS.InputBegan:connect(function(io,gpe)
	...
	elseif(io.KeyCode == Enum.KeyCode.N and Mode~='Ancient')then 
		changeMode'Ancient'
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='Hacker')then 
		changeMode'Hacking In Progress' 
	elseif(io.KeyCode == Enum.KeyCode.R and Mode~='Hacker')then 
...
WingAnims.Sex=function(mult)
	LWP1W.C0 = LWP1W.C0:lerp(CF.N(3,0,4)*CF.A(0,M.R(0+0*M.C(WingSine/36)),M.R(180+5*M.C(WingSine/100))),.2)
	LWP2W.C0 = LWP2W.C0:lerp(CF.N(0,-2,4)*CF.A(0,M.R(0+0*M.C(WingSine/32)),M.R(90+5*M.C(WingSine/100))),.2)
	LWP3W.C0 = LWP3W.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(225+WingSine*mult)),.2)
	
	RWP1W.C0 = RWP1W.C0:lerp(CF.N(-3,0,4)*CF.A(0,M.R(0+0*M.C(WingSine/36)),M.R(-180+5*M.C(WingSine/100))),.2)
	RWP2W.C0 = RWP2W.C0:lerp(CF.N(-5,-2,4)*CF.A(0,M.R(0+0*M.C(WingSine/32)),M.R(-90+5*M.C(WingSine/100))),.2)
	RWP3W.C0 = RWP3W.C0:lerp(CF.N(0,1.5,-1)*CF.A(0,M.R(0+5*M.C(WingSine/39)),M.R(225-WingSine*mult)),.2)
    RWP4W.C0 = RWP4W.C0:lerp(CF.N(-2.5,-2,4)*CF.A(0,M.R(0+0*M.C(WingSine/32)),M.R(-90+5*M.C(WingSine/100))),.2)
    RWP5W.C0 = RWP5W.C0:lerp(CF.N(4,0,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-600*M.C(WingSine/192))),.2)
    RWP6W.C0 = RWP6W.C0:lerp(CF.N(-4,0,-1)*CF.A(M.R(0+0*M.C(WingSine/32)),0,M.R(-170-600*M.C(WingSine/192))),.2)
...
elseif(State == 'Sit')then
	...
	if(State == 'Idle')then
		...
		if(Mode=='Achromatix')then
			...
			local Alpha = .1
			if(NeutralAnims)then	
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,0+0.1*M.C(Sine/32),0)*CF.A(M.R(0+2*M.S(Sine/64)),M.R(0.01),0),Alpha)
				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
				LS.C0 = LS.C0:lerp(LSC0*CF.N(.3,-0+.05*M.S(Sine/32),.1)*CF.A(M.R(-35),M.R(5+2.5*M.C(Sine/32)),M.R(35-1.5*M.C(Sine/32))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(90-0*M.C(Sine/32)),M.R(140+5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LH.C0 = LH.C0:lerp(LHC0*CF.N(0,0-0*M.C(Sine/32),0),Alpha)
			...
			elseif(Mode=='Hacking In Progress')then
			local Alpha = .1
			if(NeutralAnims)then	
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,0+0.1*M.C(Sine/32),0)*CF.A(M.R(0+2*M.S(Sine/64)),M.R(0.01),0),Alpha)
				NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(-5),0),Alpha)
				LS.C0 = LS.C0:lerp(LSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(-90+0*M.C(Sine/5)),M.R(-50-50*M.C(Sine/5))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(0,0+.05*M.S(Sine/32),0)*CF.A(0,M.R(90-0*M.C(Sine/5)),M.R(50+50*M.C(Sine/7))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LH.C0 = LH.C0:lerp(LHC0*CF.N(0,0-0*M.C(Sine/32),0),Alpha)
